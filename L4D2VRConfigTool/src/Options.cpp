...
Option g_Options[] =
{
    ...
    },
    {
        ...
        OptionType::Float,
        { u8"Input / Mouse Mode", u8"输入 / 键鼠模式" },
        { u8"Yaw Smoothing", u8"水平转向平滑" },
        { u8"Smooths mouse yaw turning to avoid a low-FPS feel.",
          u8"平滑鼠标水平转向，避免转动像低帧率。" },
        { u8"0 disables smoothing; 0.03~0.08 is usually enough.",
          u8"0 关闭平滑；0.03~0.08 通常足够。" },
        0.0f, 0.2f,
        "0.05"
    },
    {
