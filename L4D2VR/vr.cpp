...
void VR::CreateVRTextures()
{
    ...
    // black in SteamVR.
    // HUD overlays need alpha. On PC build, only handle formats that exist outside _X360.
    // HUD overlays need alpha. On PC build, _X360-only ImageFormat enums do not exist.
