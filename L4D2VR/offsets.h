...
public:
    ...
    Offset CBaseEntity_SetAbsOrigin_Server = { "server.dll", 0, "83 EC 44 53 55 56 8B 74 24 54 57 8B F9 F3 0F 10 06 F3 0F 10 4E 04 F3 0F 10 56 08" };
    Offset CBaseEntity_SetAbsOrigin_Client = { "client.dll", 0, "83 EC 44 53 55 56 8B 74 24 54 57 8B F9 F3 0F 10 06 F3 0F 10 4E 04 F3 0F 10 56 08" };
