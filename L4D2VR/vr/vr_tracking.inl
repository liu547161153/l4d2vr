void VR::UpdateTracking()
{
    ...
    // Only allow roomscale camera anchoring while "standing still" (velocity==0), and disable while thumbstick locomotion is active.
    ...
    {
        // Mounted guns force first-person render path; keep roomscale anchor coupled.
        m_RoomscaleActive = false;
    }
