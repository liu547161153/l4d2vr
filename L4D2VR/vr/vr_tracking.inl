void VR::UpdateTracking()
{
    ...
    // Roomscale camera behavior (legacy):
    // - Allow roomscale camera anchoring while "standing still" (velocity==0).
    // - Disable while thumbstick / keyboard locomotion is active.
    ...
    else if (usingMountedGunNow)
    {
        ...
        // first/third-person render-path thrashing.
        m_RoomscaleActive = false;
    }
    ...
    // Keep the legacy "camera following" escape hatch.
