...
2. Launch SteamVR, then launch Left 4 Dead 2 with these launch options:
   ...
   ``` -insecure -heapsize 524288 -processheap -high -window -novid +mat_motion_blur_percent_of_screen_max 0 +crosshair 0 -w 1280 -h 720 +mat_queue_mode 0 +mat_vsync 0 +mat_antialias 0 +mat_grain_scale_override 0 ```
